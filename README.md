...
## 성능 (테스트 기간: 2025-07-01 ~ 2026-05-29, 230 영업일)

| 방식 | Top3 일평균 타율 | 베이스라인 대비 |
|---|---|---|
| 시장 평균 (베이스라인) | 0.3733 | 1.00배 |
| LightGBM 단독 | 0.5526 | 1.48배 |
| **앙상블 AND 게이트** | **0.5858** | **1.57배** |

> LSTM 라벨을 GBM과 동일한 "3일 +2.5%"에서 **"20일 수익률 당일 상위 30%"** 로 변경하여
> 두 모델의 역할을 분리(단기 타이밍 vs 중기 추세)한 결과 앙상블이 GBM 단독을 초과했다.
